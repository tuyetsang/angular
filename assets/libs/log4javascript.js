...
(function(factory, root) {
	...
	Logger.prototype.getLevelByName = function(level) {
		switch (level) {
			case 'ALL' : 	return new Level(Number.MIN_VALUE, "ALL");
							break;
			case 'TRACE' :	return new Level(10000, "TRACE");
							break;
			case 'DEBUG' :	return new Level(20000, "DEBUG");
							break;
			case 'INFO' :	return new Level(30000, "INFO");
							break;
			case 'WARN' :	return new Level(40000, "WARN");
							break;
			case 'ERROR' :	return new Level(50000, "ERROR");
							break;
			case 'FATAL' :	return new Level(60000, "FATAL");
							break;
			case 'OFF' :	return new Level(Number.MAX_VALUE, "OFF");
							break;
			default :	return new Level(30000, "INFO");
		}
	}
